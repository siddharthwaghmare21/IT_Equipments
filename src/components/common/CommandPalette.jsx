...
export default function CommandPalette({ currentUser }) {
  ...
  return (
    <div className="fixed inset-0 z-[75] bg-black/50 px-4 pt-20">
      <section className="mx-auto max-w-xl rounded-2xl border border-gray-200 bg-white p-4 shadow-xl">
        ...
        <input
          ...
          className="mt-4 w-full rounded-xl border border-gray-300 px-4 py-2.5 text-sm outline-none focus:border-gray-900"
        />
