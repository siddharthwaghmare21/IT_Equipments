        ...
        <header className="report-letterhead border-b-2 border-gray-900 bg-white px-5 py-4 dark:!border-slate-700 dark:!bg-slate-900">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="no-print flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <label className="flex min-w-[150px] flex-col gap-1 text-xs font-semibold text-gray-600 dark:!text-slate-200">
                Print Format
                <select
                  value={printFormat}
                  onChange={(event) => setPrintFormat(event.target.value)}
                  className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm font-semibold text-gray-700 outline-none focus:border-gray-900 dark:!border-slate-600 dark:!bg-slate-950 dark:!text-white"
                >
